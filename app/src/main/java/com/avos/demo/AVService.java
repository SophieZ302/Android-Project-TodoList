...
public class AVService {
  public static void AVInit(Context ctx) {
    ...
    AVOSCloud.initialize(ctx, "ktCw4LWW3FgjXa1a2HQpnRLx-gzGzoHsz",
        "Pr8eIgylLGqeAN7ibH3UiCnU");
    // 启用崩溃错误报告
  ...
  public static void createOrUpdateTodo(String objectId, String name, String price, String content, SaveCallback saveCallback) {
